...
export type HubVariant = "featured" | "side" | "sideTall" | "media" | "maze";

/** Tinggi seragam kartu baris 2 (Bomberman & maze) */
const ROW2_CARD =
...
export function GameCard({
  ...
  if ((variant === "side" || variant === "sideTall") && coverImage) {
    const sideShellClass =
      variant === "sideTall"
        ? `${baseMotion} ${ROW2_CARD} w-full bg-secondary-container/20`
        : `${baseMotion} flex h-[450px] w-full flex-col overflow-hidden bg-secondary-container/20`;
    return (
      <div className="md:col-span-4">
        <Link href={href} className={sideShellClass}>
